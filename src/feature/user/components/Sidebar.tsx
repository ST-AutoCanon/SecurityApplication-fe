...
//     {
//       name: "Dashboard",
//       path: "/security/organisation/dashboard",
//       icon: <LayoutDashboard size={22} />,
//     },
//     {
//       name: roleName,
//       path: "/security/organisation/create_security",
//       icon: <Building2 size={22} />,
//     },
//     {
//       name: "Registration",
//       path: "/security/organisation/manage_registration",
//       icon: <LayoutDashboard size={22} />,
//     },
//   ];
...
//               <h1 className="text-lg font-semibold">{roleName}</h1>
//             </div>
...
export default function Sidebar() {
  ...
  const links = [
    ...
    {
      name: "User Data",
      path: "/user/organisation/user-data",
      icon: <Users size={22} />,
    },
  ];
