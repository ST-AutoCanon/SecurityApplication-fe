...
//   const visibleFields = (form?.fields || []).filter((field: any) => field.type !== "reference-image");
//   const referenceImage = (form?.fields || []).find((field: any) => field.type === "reference-image")?.referenceUrl || "";
...
//                     field.type === "tel"
//                       ? (e) => {
//                           // Block letters and non-digit keys (allow navigation/edit keys)
//                           const allowed = [
//                             "Backspace",
//                             "Delete",
//                             "Tab",
